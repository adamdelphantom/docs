...
<CardGroup cols={2}>
  <Card title="Mobile" icon="sparkles" href="https://ghost-testing.mintlify.app/mobile">
    ![Hero Dark Pn](/images/hero-dark.png)
  </Card>
  <Card title="Web" icon="sparkles" href="https://ghost-testing.mintlify.app/web">
    ![Hero Dark Pn](/images/hero-dark.png)
  </Card>
  <Card title="API" icon="sparkles" href="https://ghost-testing.mintlify.app/api">
    ![Hero Dark Pn](/images/hero-dark.png)
  </Card>
